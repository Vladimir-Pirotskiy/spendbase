...
export class NftItem implements Contract {
    ...
    async sendTransfer(provider: ContractProvider, via: Sender, value: bigint, opts: {queryId: number, newOwner: Address, response: Address, forwardAmount: bigint, payload: Builder}) {
        await provider.internal(via, {
            value,
            sendMode: SendMode.PAY_GAS_SEPARATELY,
    ...
    async sendTransferEditorship(provider: ContractProvider, via: Sender, value: bigint, opts: {queryId: number, newEditor: Address, response: Address, forwardAmount: bigint, payload: Builder}) {
        await provider.internal(via, {
            value,
            sendMode: SendMode.PAY_GAS_SEPARATELY,
    ...
    async sendEditContent(provider: ContractProvider, via: Sender, value: bigint, opts: {queryId: number, content: Cell}) {
        await provider.internal(via, {
            value,
            sendMode: SendMode.PAY_GAS_SEPARATELY,
